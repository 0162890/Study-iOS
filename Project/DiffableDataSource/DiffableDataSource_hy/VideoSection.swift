...
extension VideoSection {
    static var allSections: [VideoSection] = [
        VideoSection(title: "SwiftUI", videos: [
            Video(
                title: "SwiftUI",
        ...
        VideoSection(title: "UIKit", videos: [
            Video(
        ...
        VideoSection(title: "Frameworks", videos: [
            Video(
        ...
        VideoSection(title: "Miscellaneous", videos: [
            Video(
